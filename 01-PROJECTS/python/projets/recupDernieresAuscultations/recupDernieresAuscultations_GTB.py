...
"""
Recuperation des dernieres auscultations GTB.

Ce script parcourt les repertoires d'auscultation GTB et recupere les 10 dernieres lignes
...
# Configuration
BASE_AUSCULTATION = Path(r"C:\data\11-CHANTIERS\BURE\22-AUSCULTATION\GTB")
REPERTOIRES_GTB = [
    "01-double carrure",
    "02-SMC carrefour - GRD2-T48",
    "03-SMC carrefour - GRD3-C52",
    "04-SMC carrefour - GRD3-C63",
    "05-SMC carrefour - GT7-C61",
    "06-SMC GTB 004",
    "07-SMC GTB 009",
    "08-SMC GTB 016",
    "09-SMC GTB 024",
...
def main():
    parser = argparse.ArgumentParser(description="Recupere les dernieres auscultations GTB depuis les fichiers Excel.")
    parser.add_argument("--output", "-o", type=Path, 
                       default=Path("dernieres_auscultations_GTB.csv"),
                       help="Fichier CSV de sortie (defaut: dernieres_auscultations_GTB.csv)")
    ...
    for nom_repertoire in REPERTOIRES_GTB:
    ...
    if donnees_recuperees:
        ...
        print(f"\n=== RESUME ===")
        print(f"Fichiers traites avec succes : {nb_fichiers_traites}/{len(REPERTOIRES_GTB)}")
