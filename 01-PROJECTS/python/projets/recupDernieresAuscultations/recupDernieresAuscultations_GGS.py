...
"""
Recuperation des dernieres auscultations GGS.

Ce script parcourt les repertoires d'auscultation GGS et recupere les 10 dernieres lignes
...
# Configuration
BASE_AUSCULTATION = Path(r"C:\data\11-CHANTIERS\BURE\22-AUSCULTATION\GGS")
REPERTOIRES_GGS = [
    "01-double carrure",
    "02-SMC carrefour - GRD5",
    "03-SMC carrefour - GRD6",
    "04-SMC carrefour - GVA",
    "05-SMC Galerie S4 - GGS 03",
    "06-SMC Galerie S4 - GGS 07", 
    "07-SMC entonnement - GGS 20",
    "08-SMC Grande section GGS 31"
]
...
def main():
    parser = argparse.ArgumentParser(description="Recupere les dernieres auscultations GGS depuis les fichiers Excel.")
    parser.add_argument("--output", "-o", type=Path, 
                       default=Path("dernieres_auscultations_GGS.csv"),
                       help="Fichier CSV de sortie (defaut: dernieres_auscultations_GGS.csv)")
    ...
    for nom_repertoire in REPERTOIRES_GGS:
    ...
    if donnees_recuperees:
        ...
        print(f"\n=== RESUME ===")
        print(f"Fichiers traites avec succes : {nb_fichiers_traites}/{len(REPERTOIRES_GGS)}")
