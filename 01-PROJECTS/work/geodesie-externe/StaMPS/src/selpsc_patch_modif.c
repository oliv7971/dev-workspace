...
try {
  ...
  cout << "LAAAAAAAAAAAAAAAAAAA"; //RAJOUTER TEST
//  char *ijname;
...
//  else ampoutname = argv[3];   
  ...
  ifstream file("partage/DONNEES_LAVALETTE/LAVALETTE/INSAR_20160701/pscands.GAMMA");
  if(!file)            // If the file was not found, then file is 0, i.e. !file=1 or true.
     return false;    // The file was not found.
  else                 // If the file was found, then file is non-0.
     return true;     // The file was found.
    std::basic_ifstream<char> file = ijname




  //ifstream ListeGAMMA("partage/DONNEES_LAVALETTE/LAVALETTE/INSAR_20160701/pscands.GAMMA");  //On essaye d'ouvrir le fichier

  //if(ListeGAMMA)  //On teste si tout est OK
  //{
    //  ListeGAMMA >> ijname; //Tout est OK, on peut utiliser le fichier
  //}
  //else
  //{
    //  cout << "Pas de liste GAMMA utilisée" << endl;
  //}
